...
class TransformationRotaReady:
    ...
    def cleaning(self):
        ...
        st.write('Cleaning done - %s seconds' % round((time.time() - start_time)))
    ...
    def transformation1(self):
        ...
        st.write('Transformation 1/4 done - %s seconds' % round((time.time() - start_time)))
        return self.df
    ...
    def transformation2(self):
        ...
        st.write('Transformation 2/4 done - %s seconds' % round((time.time() - start_time)))
        return self.df
    ...
    def transformation3(self):
        ...
        st.write('Transformation 3/4 done - %s seconds' % round((time.time() - start_time)))
        return self.df
    ...
    def transformation4(self):
        ...
        st.write('Transformation 4/4 done - %s seconds' % round((time.time() - start_time)))
        return self.df

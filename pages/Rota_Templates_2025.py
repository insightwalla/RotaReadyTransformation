...
def handle_single_file(file):
    ...
    df_A = pd.read_excel(file, sheet_name='Rota_A_25')
    df_B = pd.read_excel(file, sheet_name='Rota_B_25')
    df_C = pd.read_excel(file, sheet_name='Rota_C_25')
    df_D = pd.read_excel(file, sheet_name='Rota_D_25')
    df_E = pd.read_excel(file, sheet_name='Rota_E_25')
    df_F = pd.read_excel(file, sheet_name='Rota_F_25')
    df_rota_lookup = pd.read_excel(file, sheet_name='2025RotaLookup')

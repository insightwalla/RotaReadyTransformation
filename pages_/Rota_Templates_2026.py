...
def handle_single_file(file):
    ...
    df_A = pd.read_excel(file, sheet_name='Rota_A_26')
    df_B = pd.read_excel(file, sheet_name='Rota_B_26')
    df_C = pd.read_excel(file, sheet_name='Rota_C_26')
    df_D = pd.read_excel(file, sheet_name='Rota_D_26')
    df_E = pd.read_excel(file, sheet_name='Rota_E_26')
    df_F = pd.read_excel(file, sheet_name='Rota_F_26')
    df_rota_lookup = pd.read_excel(file, sheet_name='2026RotaLookup')
